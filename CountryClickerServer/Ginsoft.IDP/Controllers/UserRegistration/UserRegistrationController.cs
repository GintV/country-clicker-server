...
namespace Ginsoft.IDP.Controllers.UserRegistration
{
    ...
    {
        public UserRegistrationController(IGinsoftUserRepository ginsoftUserRepository, IIdentityServerInteractionService interactionService) {
        ...
        public async Task<IActionResult> RegisterUser(RegisterUserViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                userToCreate.Claims.Add(new Entities.UserClaim("nickname", model.Nickname));
                ...
                GinsoftUserRepository.AddUser(userToCreate);
