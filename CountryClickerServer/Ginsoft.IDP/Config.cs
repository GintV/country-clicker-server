...
namespace Ginsoft.IDP
{
    public static class Config
    {
        ...
        internal static IEnumerable<ApiResource> GetApiResources()
        {
            return new[]
            {
                new ApiResource("countryclickerapi", "Country Clicker API", new [] { "role" })
                {
        ...
        public static List<Client> GetClients()
        {
            return new List<Client>
            {
                new Client
                {
                    ClientName = "CountryClicker",
                    ClientId="countryclickerclient",
                    ...
                    IdentityTokenLifetime = 99999999,
                    AccessTokenLifetime = 99999999,
                    AuthorizationCodeLifetime = 99999999,
