...
namespace CountryClicker.Client.Services
{
    public interface ICountryClickerHttpClient
    {
        Task<HttpClient> GetClient();
        Task<string> GetValidAccessToken();
    }

    public class CountryClickerHttpClient : ICountryClickerHttpClient
    {
        private readonly IHttpContextAccessor _httpContextAccessor;
        private HttpClient _httpClient = new HttpClient();

        public CountryClickerHttpClient(IHttpContextAccessor httpContextAccessor)
        {
        ...
        private async Task<string> RenewTokens()
        {
            ...
            var tokenClient = new TokenClient(metaDataResponse.TokenEndpoint,
                "countryclickerclient", "ItsMySecret");
