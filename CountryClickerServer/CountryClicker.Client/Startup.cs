...
namespace CountryClicker.Client
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // register an ICountryClickerHttpClient
            services.AddScoped<ICountryClickerHttpClient, CountryClickerHttpClient>();
            ...
            .AddOpenIdConnect("oidc", options =>
            {
                ...
                options.ClientId = "countryclickerclient";
                ...
                options.Scope.Add("countryclickerapi");
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseMvc(routes =>
            {
                routes.MapRoute(
                    name: "default",
                    template: "{controller=Dark}/{action=Index}/{id?}");
            });
        }
    }
}
